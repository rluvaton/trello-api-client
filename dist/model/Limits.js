...
var _LimitsAttachments = _interopRequireDefault(require("./LimitsAttachments"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('attachments')) {
          obj['attachments'] = _LimitsAttachments["default"].constructFromObject(data['attachments']);
        }
      }
