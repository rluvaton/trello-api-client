 ...
 * @version 0.0.1
 */
var EnterpriseIdp = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>EnterpriseIdp</code>.
   * @alias module:model/EnterpriseIdp
   */
  function EnterpriseIdp() {
    _classCallCheck(this, EnterpriseIdp);
  ...
  _createClass(EnterpriseIdp, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('requestSigned')) {
          obj['requestSigned'] = _ApiClient["default"].convertToType(data['requestSigned'], 'Boolean');
        }
