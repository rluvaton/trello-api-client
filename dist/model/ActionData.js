...
var _ActionDataBoard = _interopRequireDefault(require("./ActionDataBoard"));

var _ActionDataCard = _interopRequireDefault(require("./ActionDataCard"));

var _ActionDataList = _interopRequireDefault(require("./ActionDataList"));
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('card')) {
          obj['card'] = _ActionDataCard["default"].constructFromObject(data['card']);
        }

        if (data.hasOwnProperty('board')) {
          obj['board'] = _ActionDataBoard["default"].constructFromObject(data['board']);
        }

        if (data.hasOwnProperty('list')) {
          obj['list'] = _ActionDataList["default"].constructFromObject(data['list']);
        }
      }
