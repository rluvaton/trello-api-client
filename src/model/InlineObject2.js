...
class InlineObject2 {
     ...
     */
    constructor(idModel, modelType, name, type, pos) { 
     ...
     */
    static initialize(obj, idModel, modelType, name, type, pos) { 
        obj['idModel'] = idModel;
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('display_cardFront')) {
                obj['display_cardFront'] = ApiClient.convertToType(data['display_cardFront'], 'Boolean');
            }
        }
        return obj;
    }
