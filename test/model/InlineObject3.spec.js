...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrelloRestApi.InlineObject3();
  });
  ...
  describe('InlineObject3', function() {
    it('should create an instance of InlineObject3', function() {
      ...
      //var instane = new TrelloRestApi.InlineObject3();
      //expect(instance).to.be.a(TrelloRestApi.InlineObject3);
    });
    ...
    it('should have the property displayCardFront (base name: "display/cardFront")', function() {
