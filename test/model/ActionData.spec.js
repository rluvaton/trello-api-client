...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrelloRestApi.ActionData();
  });
  ...
  describe('ActionData', function() {
    it('should create an instance of ActionData', function() {
      // uncomment below and update the code to test ActionData
      //var instane = new TrelloRestApi.ActionData();
      //expect(instance).to.be.a(TrelloRestApi.ActionData);
    });
