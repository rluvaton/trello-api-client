...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrelloRestApi.ActionMemberCreator();
  });
  ...
  describe('ActionMemberCreator', function() {
    it('should create an instance of ActionMemberCreator', function() {
      // uncomment below and update the code to test ActionMemberCreator
      //var instane = new TrelloRestApi.ActionMemberCreator();
      //expect(instance).to.be.a(TrelloRestApi.ActionMemberCreator);
    });
