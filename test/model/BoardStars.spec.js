...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrelloRestApi.BoardStars();
  });
  ...
  describe('BoardStars', function() {
    it('should create an instance of BoardStars', function() {
      // uncomment below and update the code to test BoardStars
      //var instane = new TrelloRestApi.BoardStars();
      //expect(instance).to.be.a(TrelloRestApi.BoardStars);
    });
