...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TrelloRestApi.ActionDataCard();
  });
  ...
  describe('ActionDataCard', function() {
    it('should create an instance of ActionDataCard', function() {
      // uncomment below and update the code to test ActionDataCard
      //var instane = new TrelloRestApi.ActionDataCard();
      //expect(instance).to.be.a(TrelloRestApi.ActionDataCard);
    });
